...
class CustomOptions extends AbstractModifier
{
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
                        ...
                        'swatches' => $this->getSwatchesConfig(70),
                    ]
                ]
            ]
        ];
     ...
     * @since 101.0.0
     */
    protected function getSwatchesConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        // 'dataScope' => static::FIELD_SKU_NAME,
                        // 'dataType' => Text::NAME,
                        'template' => 'Magento_Swatches/swatch-visual',
                        'component' => 'Magento_Swatches/js/form/element/swatch-visual',
                        'uploadUrl' => 'swatches/iframe/show',
                        //'dataScope' => 'switch',
                        //'prefixName' => 'swatchvisual.values',
                        //'prefixElementName' => 'option_',
                        'additionalClasses' => 'swatches-visual-col',
                        'sortOrder' => $sortOrder,
                    ],
                ],
            ],
