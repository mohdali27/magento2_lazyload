...
class ModifierFormDataProvider extends Dynamic
{
     ...
     * @var string
     */
    protected $_buttonTitle = 'Assign Locations';
    ...
    protected function fillModifierMeta()
    {
        return [
            ...
            'object_name' => $this->getTextColumn('object_name', false, __('Location'), 20),
            'role_id' => [
                'arguments' => [
                    'data' => [
                        'config' => [
    ...
    {
        $grid = parent::getDynamicGrid();
        $grid['arguments']['data']['config']['template'] = 'Magestore_InventorySuccess/dynamic-rows/permission/staff/dynamic-rows-grid';
        return $grid;
    }
}
