...
class ProductList extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\External\Form\Modifier\ExternalStock
{
    ...
    protected $fromExternalListing = 'os_transferstock_from_external_warehouse_product_stock_listing';
    
    protected $toExternalListing = 'os_transferstock_warehouse_product_stock_listing';
